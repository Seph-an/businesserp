...
* #247 [fixed] - After the Fresh Installation of Gap Recruitment, we can see the Dashboard is appearing. It should open up with Roles Section.
...
* #828 [fixed] - Update APP_NAME from Gap Recruitment to YourERP.
